  ...
  return (
    ...
    <section className={styles.section}>
      ...
      <div className={`${styles.icon_whatsapp} ${isSocial ? "" : styles.animation}`} onClick={openSocial}>
          {!isSocial ?
            // open icon
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24"><path fill="none" stroke={path === "/" ? "currentColor" :  "#FF8A00"} stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12.5 3.004a33 33 0 0 0-2.67.067c-4.184.278-7.516 3.657-7.79 7.9a20 20 0 0 0 0 2.52c.1 1.545.783 2.976 1.588 4.184c.467.845.159 1.9-.328 2.823c-.35.665-.526.997-.385 1.237c.14.24.455.248 1.084.263c1.245.03 2.084-.322 2.75-.813c.377-.279.566-.418.696-.434s.387.09.899.3c.46.19.995.307 1.485.34c1.425.094 2.914.094 4.342 0c4.183-.278 7.515-3.658 7.789-7.9c.042-.655.051-1.328.027-1.991M8.5 15h7m-7-5H12m3-4.5h7M18.5 2v7" color="currentColor"/></svg>
            // close icon
          :
